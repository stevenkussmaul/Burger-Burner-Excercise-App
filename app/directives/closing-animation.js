...
function closingAnimation() {
    return {
        ...
        link: function ($scope, $element, $attrs) {
            ...
            let closingTimeline = anime.timeline(); 
            // let showTitle = false;
            ...
            closingTimeline
                ...
                .add({
                    targets: '.closing-instructions__text',
                    opacity: 1,
                    duration: 500,
                    offset: '-=300'
                ...
                .add({
                    targets: '.closing-instructions__btn',
                    opacity: 1,
                    height: '30px',
                    width: '85%',
                    fontSize: '16px',
...
angular.module("App").directive("closingAnimation", closingAnimation);