...
const home = {
    ...
    <p class="intro intro--are">are</p>
    <p class="intro intro--u">u</p>
    <p class="intro intro--ready">ready</p>
    <p class="intro intro--to">to</p>
    <p class="intro intro--burn">burn</p>
    <p class="intro intro--qs">???</p>
